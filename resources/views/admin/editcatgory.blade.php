            ...
            <div class="col-md-8 col-md-offset-2">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form  method="post" action="{{url('upadtecatgory/'.$catgories->id)}} " enctype="multipart/form-data"  >
                            {{csrf_field()}}
                            <input type="hidden" name="_token" value="{{csrf_token()}}">
                            <input  value="{{$catgories->name}}" class="form-control" type="text" name="name" placeholder=" catgoryname"><br>
                            @if($errors->get('name'))
